    ...
    size_t infos_length)
{
    ...
    case 2:
    {
        if (is_create_stake_account(infos, infos_length) || is_create_stake_account_checked(infos, infos_length))
        {
            return print_create_stake_account(header, infos, infos_length);
        }
        else if (is_create_stake_account_with_seed(infos, infos_length) || is_create_stake_account_with_seed_checked(infos, infos_length))
        {
        ...
        else if (is_stake_authorize_both(infos, infos_length) || is_stake_authorize_checked_both(infos, infos_length))
        {
            return print_stake_authorize_both(header, infos, infos_length);
        }
        else if (is_vote_authorize_both(infos, infos_length) || is_vote_authorize_checked_both(infos, infos_length))
        {
        ...
        else if (is_spl_token_create_account(infos, infos_length) || is_spl_token_create_account2(infos, infos_length))
        {
        ...
        else if (is_spl_token_create_account_with_seed(infos, infos_length) || is_spl_token_create_account2_with_seed(infos, infos_length))
        {
